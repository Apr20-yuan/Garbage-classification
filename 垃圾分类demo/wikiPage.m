...
#pragma mark tableView
    _tableView = [[UITableView alloc]initWithFrame:CGRectMake(7, self.navigationController.navigationBar.frame.size.height+[[UIApplication sharedApplication] statusBarFrame].size.height+40+10, SC_Width-14, SC_Height) style:UITableViewStyleGrouped];
